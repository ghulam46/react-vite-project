    ...
    return(
        <div className="App">
            <div className="p-10">
                ...
                {productInStock === 0 ? <button className="border-2 border-red-500 px-10 mr-3 opacity-25" onClick={decreaseProduct}>-</button> : <button className="border-2 border-red-500 px-10 mr-3" onClick={decreaseProduct}>-</button>}
                {productInStock}
                <button className="border-2 border-green-500 px-10 ml-3 mb-5" onClick={increaseProduct}>+</button><br/>
                <button className="border-2 border-green-500 px-10 ml-3 mb-5" onClick={resetProduct}>Reset</button><br/>
